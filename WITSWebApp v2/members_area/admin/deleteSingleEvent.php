...
<div class="container">
    ...
    <div class="mainContent"> 
        <div class="middleLine">
            <?php
                echo"<p class=\"warning\">Are you sure you want to Delete this record?</p>";
                    echo"<a href=\"../../processes/deleteEvent.php?eventID=".$eventID."\">";
                        echo"<button class=\"cancel\">Yes: Delete</button>";
                    echo"</a>";

                    echo"<a href=\"../admin.php\">";
                        echo"<button class=\"cancel\">No: Go Back</button>";
                    echo"</a>";
            ?>
            ...
            <div class = "singleEventImage">
                <?php
                    echo"<img src=\"../../images/events/".$event->imageLink."\"></img>";
                ?>
            </div>
